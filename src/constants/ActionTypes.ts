...
/* TAGLESS INCIDENT */
export const TAGLESS_INCIDENT_COUNTER = "TAGLESS_INCIDENT_COUNTER";
export const TAGLESS_INCIDENT_LIST = "TAGLESS_INCIDENT_LIST";
export const ADD_IMAGE_TO_INCIDENT = "ADD_IMAGE_TO_INCIDENT";
export const ADD_HANDOVER_DETAILS_TO_INCIDENT = "ADD_HANDOVER_DETAILS_TO_INCIDENT";
export const RESET_IMAGE_LIST = "RESET_IMAGE_LIST";
export const ADD_RACK_NUMBER_TO_INCIDENT = "ADD_RACK_NUMBER_TO_INCIDENT";
